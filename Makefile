...
OBJS = init.o defineHouse.o drawHouse.o drawAxes.o drawSign.o reshape.o display.o mouse.o keyboard.o specialinput.o viewtype.o  
...
mouse.o : mouse.cc $(HEADERS)
	$(CC) $(CFLAGS) mouse.cc -c
